...
Claire is a CIO in a large company. She is methodical, demanding, and under a lot of pressure. She must ensure that the digital projects she initiates are carried out by reliable, competent providers who can understand the business stakes.
...
| **2. Exploration**        | Verify that you understand her stakes         | Fear of encountering a too “generalist” profile | Concrete cases, results-oriented approach         | “Method” page, “Services” pages tailored for CIOs       |
...
- Value **experience**, **methodology**, and **references**
- Structure the site in a fluid, clear manner, without overload
- Provide **proof of trust**: testimonials, concrete achievements
