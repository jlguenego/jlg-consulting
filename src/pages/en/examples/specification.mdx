---
title: "Site Specification JLG Consulting"
...
# 📄 Specification of the _JLG Consulting_ Site
...
| `openai`                           | Used to **automatically translate** the `/fr` pages to `/en` during the build.              |
...
- Users write pages in French in `/fr`.
- An **automatic generation script** produces equivalent pages in `/en`.
...
- `meta` tags tailored for each page.
